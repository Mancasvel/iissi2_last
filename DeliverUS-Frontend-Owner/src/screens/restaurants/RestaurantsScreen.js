  ...
  const renderRestaurant = ({ item }) => {
    return (
      ...
      >
        ...
        <TextRegular textStyle={{ textAlign: 'right', marginBottom: '-40px' }}>Currently sorting products<TextSemiBold> by {item.sortByPrice ? 'price' : 'default'}</TextSemiBold></TextRegular>
        <TextRegular textStyle={{ textAlign: 'right' }}>This restaurant <TextSemiBold> {item.menu ? 'serve menus' : 'does not serve menus'}</TextSemiBold></TextRegular>
