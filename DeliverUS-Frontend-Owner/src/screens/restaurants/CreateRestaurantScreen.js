...
export default function CreateRestaurantScreen ({ navigation }) {
  ...
  const initialRestaurantValues = { name: null, description: null, address: null, postalCode: null, url: null, shippingCosts: null, email: null, phone: null, restaurantCategoryId: null, menu: false, availability: false }
  const validationSchema = yup.object().shape({
    ...
    menu: yup
      .boolean()
      .required('If it served menus or not is a field required'),
    availability: yup
      .boolean()
      .required('If it served menus or not is a field required')
  })
          ...
          <View style={{ alignItems: 'center' }}>
            <View style={{ width: '60%' }}>
              ...
              {backendErrors &&
               ...
               <TextRegular>Does it serve menus?</TextRegular>
              <Switch
                trackColor={{ false: GlobalStyles.brandSecondary, true: GlobalStyles.brandPrimary }}
                thumbColor={values.menu ? GlobalStyles.brandSecondary : '#f4f3f4'}
                value={values.menu}
                style={styles.switch}
                onValueChange={value =>
